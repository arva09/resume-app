...
# MAIN CODE
import pickle as pk
model = pk.load(open(r"C:/Users/arpit/Resume_classification_project/modelDT2.pkl", 'rb'))
Vectorizer = pk.load(open(r"C:/Users/arpit/Resume_classification_project/vector12.pkl", 'rb'))
